...
var fahrbetrieb_dataset = [0];
var fahrzeugherstellung_dataset =  [0];
var akkuherstellung_dataset =  [0];
var energiebedarf_dataset = [0];
...
$('#4').addClass('btn_checked');

var abgas_chart = new Chart(myChartObject, config);
$("#0").click(function() {
    var data = abgas_chart.config.data;
    data.datasets[0].data = [164.9, 132.0, 92.4, 130.3, 104.3, 121.2,0.6,0,0,0,0];;
    data.datasets[1].data =  [13.7,13.7,13.7,13.7,13.7,13.2,13.2,13.1,13.1,14.1,14.1];
    data.datasets[2].data = [0,1.0,3.1,0,1,0,0,12.4,12.4,2.5,2.5];
    data.datasets[3].data = [46.4,37.1,55.8,33.9,27.1,25.4,79.3,75.4,4.5,88.8,12.5];
